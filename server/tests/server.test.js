...
describe('GET/todos/:id', ()=>{
  ...
  it('should not return a todo doc creater by other user', (done)=>{
    request(app)
...
describe('PATCH/todos/:id', ()=>{
  ...
  it('should clear completedAt when todo is not completed', (done)=>{
    ...
    var text = "This is also an updated text!!!";
    request(app)
      .patch(`/todos/${id}`)
      .set('x-auth', users[1].tokens[0].token)
      .send({
...
// Lecture 94 Testing Users routes
...
describe('POST/users', ()=>{
  it('should create a user', (done)=>{
    ...
    request(app)
      ...
      .expect(200)
      .expect((res)=>{
        // Use bracket notation as x-auth has a dash
...
// LECTURE 96 Testing POST/users/login
...
// LECTURE 97 DELETE token Log Out User
